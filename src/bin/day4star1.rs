...
mod test {
    ...
    fn valid_password() {
        ...
        assert!(valid_password(&111111usize.into()));
        assert!(valid_password(&122345usize.into()));
        assert!(valid_password(&111123usize.into()));
        assert!(!valid_password(&223450usize.into()));
        assert!(!valid_password(&123789usize.into()));
    }
}
